...
func TestGetIssueContext_FullSuccess(t *testing.T) {
	...
	ctx, err := GetIssueContext(context.Background(), mockPool, "DGR-42", 1)
	if err != nil {
...
func TestGetIssueContext_NotFound(t *testing.T) {
	...
	ctx, err := GetIssueContext(context.Background(), mockPool, "DGR-999", 1)
	if err == nil {
...
func TestGetIssueContext_NoExtras(t *testing.T) {
	...
	ctx, err := GetIssueContext(context.Background(), mockPool, "DGR-1", 1)
	if err != nil {
		t.Fatalf("GetIssueContext returned error: %v", err)
	}
	if ctx == nil {
...
func TestGetIssueContext_ParentQueryUsesQualifiedID(t *testing.T) {
	...
	ctx, err := GetIssueContext(context.Background(), mockPool, "DGR-TEST", 1)
	if err != nil {
		t.Fatalf("GetIssueContext returned error: %v", err)
	}
	if ctx == nil {
